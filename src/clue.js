...
function pickMystery() {
  mysteryChoice.suspect = selectRandom(suspectsArray)
  mysteryChoice.weapon = selectRandom(weaponsArray)
  mysteryChoice.room = selectRandom(roomsArray)
